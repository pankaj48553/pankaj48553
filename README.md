...
[![React](https://skillicons.dev/icons?i=react,nextjs,vuejs,nuxtjs)](https://skillicons.dev) [web:29]
[![JS Frameworks](https://img.shields.io/badge/Vite-646CFF?style=for-the-badge&logo=vite&logoColor=white)](https://vitejs.dev/) [web:27]
...
![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black) [web:36]
...
## 🔥 Featured Projects
- 🔄 **Interactive Task Manager** - Drag & drop notes with localStorage persistence [conversation_history:46]
- ⏱️ **Dynamic Timer App** - Real-time countdown with page title updates [conversation_history:44]
- 📝 **Form Validation System** - Vue 3 reactive validation with nested fields [conversation_history:41]

## 🌟 Key Features I Build
- ⚡ Lightning-fast UIs with Vite + React/Next.js
- 🎨 Responsive designs using Tailwind + Bootstrap
...
**💼 Currently building interactive web experiences with React, Vue, and Tailwind CSS**
  
[![Footer](https://img.shields.io/badge/Portfolio-000?style=for-the-badge&logo=react&logoColor=white)](#)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/pankaj-siwach-aa79362a0)
